...
const FormThree = ({ setFormState }) => {
  ...
  const handleLoginSubmit = (values, { setSubmitting }) => {
    ...
    axios
      .post(
        "https://6297078214e756fe3b273ab8.mockapi.io/bnpl/api/debitmandate",
        {
              ...
              <FormRow>
                <div className="inner-div">
                  <InputField
                    ...
                    name="fieldone"
                    className={` ${
                      errors.fieldone && touched.fieldone ? "border-danger" : ""
                    }`}
              ...
              <FormRow>
                <div className="inner-div">
                  <InputField
                    ...
                    name="fieldtwo"
                    className={` ${
                      errors.fieldtwo && touched.fieldtwo ? "border-danger" : ""
                    }`}
